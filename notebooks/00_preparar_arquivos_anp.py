...
dbutils.widgets.text(
    "raw_root",
    "/Volumes/workspace/anp_combustiveis_br_2022_2026/anp/raw",
    "Pasta raw no Volume",
)
dbutils.widgets.text(
    "metadata_root",
    "/Volumes/workspace/anp_combustiveis_br_2022_2026/anp/metadata",
...
PRICE_ARCHIVES = (
    ...
    ExpectedInput("precos_2025_1", "precos/precos_2025_1.zip", "zip"),
    ExpectedInput("precos_2025_2", "precos/precos_2025_2.zip", "zip"),
    ExpectedInput("precos_2026_1", "precos/precos_2026_1.zip", "zip"),
)
...
SIMP_LIQUIDOS_ARCHIVE = ExpectedInput(
    "simp_liquidos",
...
EXPECTED_INPUTS = (*PRICE_ARCHIVES, LOGISTICA_ARCHIVE, SIMP_LIQUIDOS_ARCHIVE, *CSV_INPUTS)
