...
paths = {
    ...
    "venda_simp_liquidos": f"{RAW_ROOT}/liquidos/extraidos/liquidos_vendas_atual.csv",
...
simp_liquidos = read_csv(
    paths["venda_simp_liquidos"],
    "anp_simp_liquidos_vendas",
    encoding="ISO-8859-1",
)
...
rows_by_table = [
    ...
    (
        "bronze_venda_simp_liquidos",
        "anp_simp_liquidos_vendas",
        write_bronze("bronze_venda_simp_liquidos", simp_liquidos),
    ),
